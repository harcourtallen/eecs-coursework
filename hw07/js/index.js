// Global Variables:
const serverURL = 'https://harcourt-hw7.herokuapp.com/';
let activeCardID = -1
let appPhotos;
...
const getImagesFromServer = (querystring) => {
...
//   fetch('https://harcourt-hw7.herokuapp.com/photos/') + photoItem.id; {
//     methods: 'PATCH',
//     headers: {
...
const loadCardDetailView = () => {
    ...
    document.querySelector('.liker').onclick = likePhoto;
...
const getPhotoDetailTemplate = (photoItem, comments) => {
    let template = `
        ...
        <button type="button" class="liker">
